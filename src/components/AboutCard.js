...
const Cardclient = (params) => {
    return (
        ...
        <p className={styles.name_client}> {params.name}
        ...
        <div className={styles.social_media}>
            ...
            <a href="#">
                ...
                <span className={styles.tooltip_social}>LinkedIn</span>
            </a>
        </div>
    </div>
...
<div className={styles.card_client}>
    ...
    <p className={styles.name_client}> Jhon Doe
