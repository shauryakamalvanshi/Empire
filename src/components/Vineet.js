    ...
    <div className={styles.main}>
      <div className="max-w-xs bg-white border   border-gray-200 rounded-lg shadow dark:bg-white-900 bg-opacity-50 mb-20  transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none">
        <a href="#">
          <Image
            ...
            alt=""
            width={1260} // Adjust width and height as needed
            height={750}
          />
        </a>
        <div className="p-5">
          ...
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Quality is at the core of our values. Our team of experts takes a detail-oriented approach to every project, ensuring that each solution we deliver is robust, scalable, and tailored to your specific needs.</p>
        </div>
      </div>
      ...
      <div className="max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:bg-white-800 mb-20 transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none">
        ...
        <div className="p-5">
          ...
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">At Pandaje Web Services, we understand the importance of reliability in business relationships. That's why we prioritize timely communication, transparent project management, and a commitment to meeting deadlines.</p>
        </div>
      </div>
      <div className="max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:bg-white-800 mb-20 transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none">
        <a href="#">
        ...
        <div className="p-5">
          ...
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">We strive for excellence in everything we do. From the quality of our code to the user experience of our solutions, we're constantly pushing ourselves to deliver the best possible results.</p>
        </div>
      </div>
    </div>
    </>
